...
navbar = dbc.NavbarSimple(
    brand='Predicting Breast Cancer with Data Science',
    brand_href='/',
    children=[
        ...
        dbc.Col(
            html.P(
                [
                    ...
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:romy.morsy@gmail.com.com'),
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/RomyMorsy'),
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/romymorsy/')
